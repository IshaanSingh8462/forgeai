...
function FeatherlessPerk() {
  return (
    <motion.div
      ...
      className="relative mx-auto max-w-3xl rounded-2xl glass p-5 md:p-6 mb-10 overflow-hidden"
    >
      <div className="relative flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
        <div className="shrink-0 h-14 w-14 rounded-xl overflow-hidden border border-white/10 bg-white/5">
          <img
        ...
        <div className="flex-1">
          ...
          <p className="font-display text-xl md:text-2xl font-bold mt-1">
            <span className="text-gradient">$25 in free API credits</span> for every participant.
          </p>
          <p className="text-mist text-xs md:text-sm mt-1.5 leading-relaxed">
            Yours to keep just for showing up — whether or not you place in the
            top 3 or win a track. Use it to run open-weight LLMs for your project,
    ...
    <section id="prizes" className="relative py-28 px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <motion.div
          ...
          className="relative mx-auto max-w-2xl rounded-3xl glass p-10 md:p-14 text-center mb-8 overflow-hidden group"
        >
